d_us <- d_us %>% 
  ...
  mutate(D2 = recode(D2,
         ...
         stance3 = ifelse(specified3 == "Underspecified" & S3 == 3, 
                          "correct", stance3),
         stance4 = ifelse(specified4 == "Specified" & S4 == 1, 
                          "correct", "not correct"),
  ...
  mutate(masking = ifelse(actor == "X", "Masked", "Party"),
         ...
         distance = 0,
         distance = ifelse(round == "round1", abs(PT6-2), distance),
         distance = ifelse(round == "round2", abs(PT6-5), distance),
         distance = ifelse(round == "round3", abs(PT6-2), distance),
         distance = ifelse(round == "round4", abs(PT6-5), distance),
