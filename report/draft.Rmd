...
- name: Kasper Welbers
- affiliation: Dep. of Communciation Science, Vrije Universiteit Amsterdam
thanks: "* = Corresponding author, Replication files are available on the author's Github account (https://github.com/MarikenvdVelden/bias-experiment); Author contributions: designed the study: MACGvdV, WvA, AF, FL, MR, & KW; conducted the study: MACGvdV, FL & MR; data cleaning & analysis: MACGvdV; writing of the paper: MACGvdV"
anonymous: TRUE
...
This question presents a fundamental challenge to the main way of working when collecting gold standard data, as we operate from the baseline assumption that disagreement among the annotators should be avoided or reduced.
...
[^1]: The data and research compendium is published on the [main author's github page](link) -- annonymized for the review process.

# Whose Truth is it Anyway? Disagreement & Perspectivism in Creating Gold Standard Data
To test whether societal trends of polarization have an effect on our crowd-coders, and by extension on the quality of our annotated gold standard data. To that end, we have formulated the following hypotheses:
